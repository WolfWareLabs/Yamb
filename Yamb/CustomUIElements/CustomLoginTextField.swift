...
class CustomLoginTextField: UITextField {
    ...
    init(_ placeholder: String) {
        ...
        if placeholder == NSLocalizedString("login.textfield.password", comment: "login.textfield.password") || placeholder == NSLocalizedString("register.textfield.confirmpassword", comment: "register.textfield.confirmpassword") || placeholder == NSLocalizedString("login.textfield.email", comment: "login.textfield.email") {
